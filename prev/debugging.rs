                ...
                match err {
                    ...
                    _ => {
                        ...
                        let err = match err {
                            ...
                            gl::INVALID_FRAMEBUFFER_OPERATION => "INVALID_FRAMEBUFFER_OPERATION".into(),
                            _ => format!("code {}", err)
                        };
...
pub extern "system" fn debug_message_callback(
    ...
    eprintln!("---------------");
    unsafe { eprintln!("Debug message ({id}): {}", CStr::from_ptr(message).to_str().unwrap()) };
    eprintln!("{source}");
    eprintln!("{error_type}");
    eprintln!("{severity}");
    eprintln!();
